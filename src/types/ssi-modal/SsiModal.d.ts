...
declare type SsiModal = SsiModal.SsiModal
declare type SsiModalOptions = SsiModal.SsiModalOptions
declare type SsiModalButtonOptions = SsiModal.SsiModalButtonOptions
declare type SsiModalSizeClass = SsiModal.SsiModalSizeClass
declare type SsiModalModalElement = SsiModal.SsiModalModalElement
declare type SsiModalEventMap = SsiModal.SsiModalEventMap
declare type SsiModalAnimation = SsiModal.SsiModalAnimation

declare global {
  interface Window {
    ssi_modal: typeof ssi_modal
  }
}
